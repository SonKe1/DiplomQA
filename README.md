...
**Сценарий №1 Оплата картой со статусом "APPROVED": "4444 4444 4444 4441" с  ипользование валидных данных.**
 1. В поле "Номер карты" ввести карту со статусом "APPROVED": "4444 4444 4444 4441"
 2. В поле "Месяц" ввести: 10
 3. В поле "Год" ввести: 23
 4. В поле "Владелец" ввести: Sergey Petrov
 5. В поле "CVC/CVV" ввести: 210
 6. Нажать кнопку "Продолжить"
 
 *Ожидаемый результат*: появляется сообщения об успешной оплате.В БД в payment_entity появилась запись со статусом APPROVED

**Сценарий №2 Оплата картой со статусом "DECLINED": "4444 4444 4444 4442" с  ипользование валидных данных.**
 1. В поле "Номер карты" ввести карту со статусом "DECLINED": "4444 4444 4444 4442"
 2. В поле "Месяц" ввести: 10
 3. В поле "Год" ввести: 23
 4. В поле "Владелец" ввести: Sergey Petrov
 5. В поле "CVC/CVV" ввести: 210
 ...
 *Ожидаемый результат*: появляется сообщения об "Ошибка! Банк отказал в проведении операции!". В БД в payment_entity появилась запись со статусом DECLINED
 ...
 **Сценарий №7 Оплата картой, в поле "Месяц" указано невалидное значение "00".**
 ...
 **Сценарий №10 Оплата картой, в поле "Год" указано значение "00".**
 1. В поле "Номер карты" ввести: "4444 4444 4444 4441"
 2. В поле "Месяц" ввести: 10
 ...
 **Сценарий №19 Оплата картой, значение поля "Владелец" заполнено кириллицей.**
 ...
 2. В поле "Месяц" ввести: 10
 3. В поле "Год" ввести: 23
 4. В поле "Владелец" ввести: Сергей Петров
 5. В поле "CVC/CVV" ввести: 210
 6. Нажать кнопку "Продолжить"
 ...
 **Сценарий №20 Оплата картой, значение поля "Владелец" заполнено латинецей только имя.** 
 ...
 2. В поле "Месяц" ввести: 10
 3. В поле "Год" ввести: 23
 4. В поле "Владелец" ввести: Sergey
 5. В поле "CVC/CVV" ввести: 210
 6. Нажать кнопку "Продолжить"
 ...
 **Сценарий №21 Оплата картой, значение поля "Владелец" заполнено латинецей только фамилия.**  
 ...
 2. В поле "Месяц" ввести: 10
 3. В поле "Год" ввести: 23
 4. В поле "Владелец" ввести: Petrov 
 5. В поле "CVC/CVV" ввести: 210
 6. Нажать кнопку "Продолжить"
 ...
 **Сценарий №22 Оплата картой, значение поля "Владелец" заполнено цифрами.**  
 ...
 2. В поле "Месяц" ввести: 10
 3. В поле "Год" ввести: 23
 4. В поле "Владелец" ввести: 646544 
 5. В поле "CVC/CVV" ввести: 210
 6. Нажать кнопку "Продолжить"
 ...
 *Ожидаемый результат*: появляется сообщения об успешной оплате. В БД в credit_request_entity появилась запись со статусом APPROVED
 ...
 *Ожидаемый результат*: всплывающее сообщение "Ошибка! Банк отказал в проведении операции!". В БД в credit_request_entity появилась запись со статусом DECLINED
 ...
 **Сценарий №7 Покупка в кредит, в поле "Месяц" указано невалидное значение "00".**
 1. В поле "Номер карты" ввести: "4444 4444 4444 4441"
 2. В поле "Месяц" ввести: 00
 3. В поле "Год" ввести: 23
 4. В поле "Владелец" ввести: Sergey Petrov
 ...
 **Сценарий №10 Покупка в кредит, в поле "Год" указано значение "00".**
 1. Открываем страницу http://localhost:8080/;
 2. Нажимаем кнопку "Купить в кредит";
 3. Выбрать форму "Кредит по данным карты"
