 ...
 *Ожидаемый результат*: отправка формы невозможна, предупреждение "Неверный формат" под полем "Номер карты"
 ...
 Сценарий  №4 Оплата картой, значение в поле "Номер карты" содержит 15 цифр.
 1. Открываем страницу http://localhost:8080/;
 2. Нажимаем кнопку "Купить";
 3. Выбрать форму "Оплата по карте"
 ...
 *Ожидаемый результат*: отправка формы невозможна, предупреждение "Неверный формат" под полем "Номер карты"
 ...
 Сценарий  №5 Оплата картой, значение в поле "Номер карты" пусто.
 1. Открываем страницу http://localhost:8080/;
 2. Нажимаем кнопку "Купить";
 3. Выбрать форму "Оплата по карте"
 ...
 *Ожидаемый результат*: отправка формы невозможна, предупреждение "Неверный формат" под полем "Номер карты"
 ...
 Сценарий  №6 Оплата картой, в поле "Месяц" указано невалидное значение "0" .
 1. Открываем страницу http://localhost:8080/;
 2. Нажимаем кнопку "Купить";
 3. Выбрать форму "Оплата по карте"
 ...
 *Ожидаемый результат*: отправка формы невозможна, предупреждение "Неверно указан срок действия карты" под полем "Месяц"
 ...
 Сценарий  №7 Оплата картой, в поле "Месяц" указано невалидное значение "13" .
 1. Открываем страницу http://localhost:8080/;
 2. Нажимаем кнопку "Купить";
 3. Выбрать форму "Оплата по карте"
 4. В поле "Номер карты" ввести: "4444 4444 4444 4441"
 ...
 *Ожидаемый результат*: отправка формы невозможна, предупреждение "Неверный формат" под полем "Месяц"
 ...
 Сценарий  №8 Оплата картой, в поле "Месяц" пусто.
 1. Открываем страницу http://localhost:8080/;
 2. Нажимаем кнопку "Купить";
 3. Выбрать форму "Оплата по карте"
 4. В поле "Номер карты" ввести: "4444 4444 4444 4441"
 ...
 *Ожидаемый результат*: отправка формы невозможна, предупреждение "Поле обязательно для заполниния" под полем "Месяц"
 ...
 Сценарий  №9  Оплата картой, в поле "Год" указано значение не более 5 лет от текущего года.
 1. Открываем страницу http://localhost:8080/;
 2. Нажимаем кнопку "Купить";
 3. Выбрать форму "Оплата по карте"
 4. В поле "Номер карты" ввести: "4444 4444 4444 4441"
 ...
 *Ожидаемый результат*: появляется сообщения об успешной оплате.
 ...
 Сценарий  №10  Оплата картой, в поле "Год" указано значение более 5 лет от текущего года.
 1. Открываем страницу http://localhost:8080/;
 2. Нажимаем кнопку "Купить";
 3. Выбрать форму "Оплата по карте"
 4. В поле "Номер карты" ввести: "4444 4444 4444 4441"
 ...
 *Ожидаемый результат*: отправка формы невозможна, предупреждение "Неверно указан срок действия карты" под полем "Год"
 ...
 Сценарий  №11  Оплата картой, значение в поле "Год" пусто.
 1. Открываем страницу http://localhost:8080/;
 2. Нажимаем кнопку "Купить";
 3. Выбрать форму "Оплата по карте"
 4. В поле "Номер карты" ввести: "4444 4444 4444 4441"
 ...
 *Ожидаемый результат*: отправка формы невозможна, предупреждение «Поле обязательно для заполнения» под полем "Год"
 ...
 Сценарий  №12  Оплата картой, значение поля "Год" указан прошедший год.
 1. Открываем страницу http://localhost:8080/;
 2. Нажимаем кнопку "Купить";
 3. Выбрать форму "Оплата по карте"
 4. В поле "Номер карты" ввести: "4444 4444 4444 4441"
 ...
 *Ожидаемый результат*: отправка формы невозможна, предупреждение "Неверно указан срок действия карты" под полем "Год"
 ...
 Сценарий  №13  Оплата картой, значение в поле "Год" указана одна цефра .
 1. Открываем страницу http://localhost:8080/;
 2. Нажимаем кнопку "Купить";
 3. Выбрать форму "Оплата по карте"
 4. В поле "Номер карты" ввести: "4444 4444 4444 4441"
 ...
 *Ожидаемый результат*: отправка формы невозможна, предупреждение "Неверный формат" под полем "Год"
 ...
 Сценарий №14 Оплата картой, значение поля "Владелец" фамилия и имя через дефис
 1. Открываем страницу http://localhost:8080/;
 2. Нажимаем кнопку "Купить";
 3. Выбрать форму "Оплата по карте"
 4. В поле "Номер карты" ввести : "4444 4444 4444 4441"
 ...
 *Ожидаемый результат*: появляется сообщения об успешной оплате.
 ...
 Сценарий №15 Оплата картой, значение поля "Владелец" фамилия и имя в верхнем регистре
 1. Открываем страницу http://localhost:8080/;
 2. Нажимаем кнопку "Купить";
 3. Выбрать форму "Оплата по карте"
 4. В поле "Номер карты" ввести : "4444 4444 4444 4441"
 ...
 *Ожидаемый результат*: появляется сообщения об успешной оплате.
 ...
 Сценарий №16 Оплата картой, значение поля "Владелец" фамилия и имя в нижнем регистре
 1. Открываем страницу http://localhost:8080/;
 2. Нажимаем кнопку "Купить";
 3. Выбрать форму "Оплата по карте"
 4. В поле "Номер карты" ввести карту со статусом "APPROVED": "4444 4444 4444 4441"
 ...
 *Ожидаемый результат*: появляется сообщения об успешной оплате.
 ...
 Сценарий №17 Оплата картой, значение поля "Владелец" пусто
 1. Открываем страницу http://localhost:8080/;
 2. Нажимаем кнопку "Купить";
 3. Выбрать форму "Оплата по карте"
 4. В поле "Номер карты" ввести: "4444 4444 4444 4441"
 ...
 *Ожидаемый результат*: отправка формы невозможна, предупреждение "Поле обязательно для заполнения" под полем "Владелец"
 ...
 Сценарий №18 Оплата картой, значение поля "Владелец" заполнено кириллицей
 1. Открываем страницу http://localhost:8080/;
 2. Нажимаем кнопку "Купить";
 3. Выбрать форму "Оплата по карте"
 4. В поле "Номер карты" ввести: "4444 4444 4444 4441"
 ...
 *Ожидаемый результат*: отправка формы невозможна, предупреждение "Неверный формат" под полем "Владелец"
 ...
 Сценарий №19 Оплата картой, значение поля "Владелец" заполнено латинецей только имя 
 1. Открываем страницу http://localhost:8080/;
 2. Нажимаем кнопку "Купить";
 3. Выбрать форму "Оплата по карте"
 4. В поле "Номер карты" ввести: "4444 4444 4444 4441"
 ...
 *Ожидаемый результат*: отправка формы невозможна, предупреждение "Неверный формат" под полем "Владелец"
 ...
 Сценарий №20 Оплата картой, значение поля "Владелец" заполнено латинецей только фамилия  
 1. Открываем страницу http://localhost:8080/;
 2. Нажимаем кнопку "Купить";
 3. Выбрать форму "Оплата по карте"
 4. В поле "Номер карты" ввести: "4444 4444 4444 4441"
 ...
 *Ожидаемый результат*: отправка формы невозможна, предупреждение "Неверный формат" под полем "Владелец"
 ...
 Сценарий №21 Оплата картой, значение поля "Владелец" заполнено цифрами  
 1. Открываем страницу http://localhost:8080/;
 2. Нажимаем кнопку "Купить";
 3. Выбрать форму "Оплата по карте"
 4. В поле "Номер карты" ввести: "4444 4444 4444 4441"
 ...
 *Ожидаемый результат*: отправка формы невозможна, предупреждение "Неверный формат" под полем "Владелец"
 ...
 Сценарий №22 Оплата картой, значение поля "Владелец" заполнено символами 
 1. Открываем страницу http://localhost:8080/;
 2. Нажимаем кнопку "Купить";
 3. Выбрать форму "Оплата по карте"
 4. В поле "Номер карты" ввести: "4444 4444 4444 4441"
 ...
 *Ожидаемый результат*: отправка формы невозможна, предупреждение "Неверный формат" под полем "Владелец"
 ...
 Сценарий №23 Оплата картой, значение поля "CVC/CVV" заполнено одной цифрой 
 1. Открываем страницу http://localhost:8080/;
 2. Нажимаем кнопку "Купить";
 3. Выбрать форму "Оплата по карте"
 4. В поле "Номер карты" ввести: "4444 4444 4444 4441"
 ...
 *Ожидаемый результат*: отправка формы невозможна, предупреждение "Неверный формат" под полем "CVC/CVV"
 ...
 Сценарий №24 Оплата картой, значение поля "CVC/CVV" заполнено двумя цифрами
 1. Открываем страницу http://localhost:8080/;
 2. Нажимаем кнопку "Купить";
 3. Выбрать форму "Оплата по карте"
 4. В поле "Номер карты" ввести: "4444 4444 4444 4441"
 ...
 *Ожидаемый результат*: отправка формы невозможна, предупреждение "Неверный формат" под полем "CVC/CVV"
  ...
  Сценарий №25 Оплата картой, значение поля "CVC/CVV" пустое
 1. Открываем страницу http://localhost:8080/;
 2. Нажимаем кнопку "Купить";
 3. Выбрать форму "Оплата по карте"
 4. В поле "Номер карты" ввести: "4444 4444 4444 4441"
